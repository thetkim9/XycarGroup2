...
set(MSG_I_FLAGS "-IYOLO:/home/user/catkin_ws/src/YOLO/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/user/catkin_ws/src/YOLO/msg/yoloMessage.msg" NAME_WE)
add_custom_target(_YOLO_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "YOLO" "/home/user/catkin_ws/src/YOLO/msg/yoloMessage.msg" ""
)
...
_generate_msg_cpp(YOLO
  "/home/user/catkin_ws/src/YOLO/msg/yoloMessage.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/YOLO)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/YOLO\")")
  # install generated code
  install(
